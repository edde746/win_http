...
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_RESOLVING_NAME = 0x00000001;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_NAME_RESOLVED = 0x00000002;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_CONNECTING_TO_SERVER = 0x00000004;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_CONNECTED_TO_SERVER = 0x00000008;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_SENDING_REQUEST = 0x00000010;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_REQUEST_SENT = 0x00000020;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_RECEIVING_RESPONSE = 0x00000040;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_RESPONSE_RECEIVED = 0x00000080;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_HANDLE_CLOSING = 0x00000800;
// ignore: constant_identifier_names
const int WINHTTP_CALLBACK_STATUS_SECURE_FAILURE = 0x00010000;
// ignore: constant_identifier_names
